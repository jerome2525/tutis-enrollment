...
class Tutis_Enrollment {
	...
	public function register_assets() {
		...
		//wp_enqueue_style( 'tutis-enrollment-css', plugin_dir_url( __FILE__ ) . 'css/main.min.css', array(), '1.0' );
		...
		//wp_enqueue_script( 'tutis-enrollment-js', plugin_dir_url( __FILE__ ) . 'js/main.min.js', array('jquery'), '1.0', true );
